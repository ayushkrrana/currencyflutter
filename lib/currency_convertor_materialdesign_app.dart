...
class CurrencyConvertorMaterial extends StatefulWidget {
  //	Immutable structure — just defines the widget
  const CurrencyConvertorMaterial({super.key});
  @override
  State<CurrencyConvertorMaterial> createState() =>
      _CurrencyConvertorMaterialPageState();
} // this class is immutable that's why we created the class below which extends the state

class _CurrencyConvertorMaterialPageState
    extends State<CurrencyConvertorMaterial> {
  //Mutable state — handles UI updates, variables, and logic
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {
              // it is used in the app bar for many actions to exit the app and many more it provides icon too
        ...
        leading: IconButton(
          onPressed: () {
            //leading is used to display anything at the top left of the screen of the app bar where as action is used to display at the top right of the appbar
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Text(
              '${result != 0 ? result.toStringAsFixed(2) : result.toStringAsFixed(0)}', // it will give the value up to 2 decimal points and we use a ternary operator here which shows 0 when there is a null value, the ternary operator acts as if else statement
              style: TextStyle(
                fontSize: 40,
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: const TextStyle(color: Colors.black),
                  prefixIcon: Padding(
                    // by this we can also declare our symbol by this
